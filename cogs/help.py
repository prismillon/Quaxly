...
class Help(commands.Cog):
    ...
    async def help(self, interaction: discord.Interaction):
        ...
        embeds[-1].add_field(name="lounge profile", value="```/lounge_profile (player)```show the lounge profile of the selected player (you if player is not provided)", inline=False)
        ...
        embeds[-1].add_field(name="war start", value="```/war start tag enemy_tag```start a war with selected teams", inline=False)
